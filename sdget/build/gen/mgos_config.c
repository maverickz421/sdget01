 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/latest/apps/sdget/esp32/build_contexts/build_ctx_400632704/build/gen/ /mongoose-os/src/mgos_debug_udp_config.yaml /mongoose-os/platforms/esp32/src/esp32_sys_config.yaml /data/fwbuild-volumes/latest/apps/sdget/esp32/build_contexts/build_ctx_400632704/build/gen/mos_conf_schema.yml
 */
...
const struct mgos_conf_entry mgos_config_schema_[417] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 416},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "rpc", .offset = offsetof(struct mgos_config, rpc), .num_desc = 38},
...
const struct mgos_config mgos_config_defaults = {
  ...
  .provision.btn.inhibit_after_s = 0,
  .provision.led.pin = -1,
...
int mgos_config_get_provision_btn_inhibit_after_s(struct mgos_config *cfg) {
  return cfg->provision.btn.inhibit_after_s;
}
void mgos_config_set_provision_btn_inhibit_after_s(struct mgos_config *cfg, int v) {
  cfg->provision.btn.inhibit_after_s = v;
}
